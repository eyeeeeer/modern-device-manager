export namespace main {
	...
	export class DrivePartition {
	    ...
	    static createFrom(source: any = {}) {
	        return new DrivePartition(source);
	    }
	...
	export class OverviewInfo {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.partitionsData = this.convertValues(source["partitionsData"], DrivePartition);
	    }
